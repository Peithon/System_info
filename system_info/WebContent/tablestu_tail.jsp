...
<div class="top">
    <div>
        <div class="top_out">
            <table class="table" >
                ...
                <tr>
                    <td style="border-top: none" >学号：<i class="i_start"></i></td>
                ...
                <tr>
                    ...
                    <td>班级：</td>
                    <td colspan = "3" style="text-align: left"><input type="text" class="long_text" ></td>
                </tr>
                 <tr>
                    <td>院名：</td>
                    <td  style="text-align: left"><select id="academy">
                        <script>
                            var academy = ["计算机科学与工程学院", "理学院", "医学院", "文法学院", "外国语学院"];
                        var option = "";
                        for(var i = 0; i <
                            academy.length; i++) {
                            option += '<option value="' + (i + 1) + '">' + academy[i] + '</option>';
                        }
                            $(option).appendTo("#academy");
                        </script>
                    </select></td>
                     <td>专业名：</td>
                    <td  style="text-align: left"><select id="major">
                        <script>
                            var major = ["计算机科学与技术", "网络工程", "软件工程"];
                        var option = "";
                        for(var i = 0; i <
                            major.length; i++) {
                            option += '<option value="' + (i + 1) + '">' + major[i] + '</option>';
                        }
                            $(option).appendTo("#major");
                        </script>
                    </select></td>
                </tr>
                <tr>
    ...
    <div class="bot_btn">
        ...
        <input class="btn" type="submit" value="保存" onclick="RecodeSave()"/>
        <button class="btn btn1"><a href="adminnav.jsp">返回</a></button>
    </div>
</div>
</form>
</body>
